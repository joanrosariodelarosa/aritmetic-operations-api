...
//    @BeforeEach
//    private void setup() {
//        calculatorServiceImpl = new CalculatorService(randomStringService);
//    }
//
//    @ParameterizedTest
...
//        ADDITION {
//            @Override
//            ResponseEntity<OperationResponseDto> performOperation(CalculatorService calculatorService, List<Double> numbers) {
...
//        };
//
//        abstract ResponseEntity<OperationResponseDto> performOperation(CalculatorService calculatorService, List<Double> numbers);
//    }
//
//    @ParameterizedTest

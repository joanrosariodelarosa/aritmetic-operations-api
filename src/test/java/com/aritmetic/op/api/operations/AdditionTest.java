...
import com.aritmetic.op.api.types.operations.Addition;
...
public class AdditionTest {
    ...
    public void testCalculateAddition() {
        ...
        ResponseEntity<OperationResponseDto> response = addition.calculate(operands);

        Assertions.assertNotNull(response);
        Assertions.assertEquals(5.5, response.getBody().getOperationResult());
    }

    @Test
    public void invalidateNegativeNumbersInAddition() {
        List<Double> operands = Arrays.asList(2.0, -1.0);
        try {
            addition.validateCalculation(operands);
    ...
    @Test
    public void invalidateMissingOperandsInAddition() {
    ...
    @Test
    public void invalidateExtraOperandInAddition() {
